    ...
    return (
        <div className=' flex xl:flex-row lg:flex-row md:flex-row sm:flex-row flex-col xl:my-4 lg:my-4 md:my-4 sm:my-4 '>            
            <div className=' flex flex-col xl:shadow-2xl shadow-black xl:w-4/6 xl:m-3'>
                <h1 className='xl:text-3xl lg:text-3xl md:text-3xl sm:text-3xl text-2xl  xl:px-12 xl:py-1 border-b-2 block'>Products</h1>
                {
                cartItems.length > 0 ? 
                cartItems.map((i) => (
            ...
            <div className='xl:px-0 lg:px-0 md:px-0 sm:px-0 px-2 fixed xl:w-1/3 lg:w-1/3 md:w-1/3 sm:w-1/3 w-full bottom-0 xl:right-4 lg:right-4 md:right-4 sm:right-4 xl:h-128 lg:h-128 md:h-128 sm:h-128 h-40 border-2 bg-white z-10'>                        
                <div className=' w-full xl:shadow-2xl shadow-black h-full'>            
                    <div className='xl:px-4 lg:px-4 md:px-4 sm:px-4 px-2 xl:py-2 lg:py-2 md:py-2 sm:py-2 py-1 border-b-2'>
                        <h1 className='xl:text-3xl lg:text-3xl md:text-3xl sm:text-3xl text-2xl'>Resume</h1>
                    </div>
